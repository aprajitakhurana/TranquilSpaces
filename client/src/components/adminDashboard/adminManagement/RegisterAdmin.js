...
const RegisterAdmin = () => {
  ...
  return (
    <div className="auth_page" style={{backgroundColor:"#4f3961"}}>
      <form onSubmit={handleSubmit} className="inner-shadow">
        <h3 className="text text-center mb-4 auth-heading"style ={{fontFamily:"Yesteryear",fontSize:"50px"}}>
         Tranquil Spaces
        </h3>
        <div className="mb-3">
          ...
          <div className="outer form-input-wrap">
            <input
              type="text"
        ...
        <div className="mb-3">
          ...
          <div className="outer-shadow hover-in-shadow form-input-wrap" style ={{borderRadius: "10px" ,border:"1px solid #4f3961" }}>
            <input
              type="text"
              className="form-control"
              id="username"
